...
from src.agents.netflix_movies import NLPAgent, recommend_netflix_movie, load_netflix_data
...
def test_recommend_netflix_movie_success(mock_post, sample_netflix_data):
    ...
    with patch('src.agents.netflix_movies.load_netflix_data', return_value=sample_netflix_data):
